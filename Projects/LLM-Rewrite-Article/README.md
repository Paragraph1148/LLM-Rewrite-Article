...
The assignment prompt mentioned fetching from Laravel APIs in Phase 3. As Phase 2 required a Node.js script and Phase 1 required creating APIs, I have connected the frontend to the Node.js/Express APIs created in Phase 1 to ensure a unified stack.
